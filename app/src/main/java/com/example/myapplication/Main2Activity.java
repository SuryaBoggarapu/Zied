...
private class MyTask extends AsyncTask <Void, Void, Void>{
       ...
       protected Void doInBackground(Void... params){
           ...
           try{
               ...
               url = new URL("http://172.26.223.40:8080/WebApplication5/webresources/mobile/removeproduct&" +InfoReceivedId);
               ...
               o1 = ""+obj.getInt("P_ID");
               o2 = ""+obj.getInt("P_NAME");
               o3 = ""+obj.getString("NET_WEIGHT");
               o4 = ""+obj.getString("C_ID");
